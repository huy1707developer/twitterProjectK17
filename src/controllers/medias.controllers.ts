...
export const serveVideoController = (req: Request, res: Response, next: NextFunction) => {
  ...
  const videoPath = path.resolve(UPLOAD_VIDEO_DIR, namefile) //lấy được đường dẫn tới file video
  ...
  // nếu mà start + chunk_size lớn hơn cái video thì gán end = videoSize-1
