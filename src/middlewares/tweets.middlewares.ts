      ...
      parent_id: {
        custom: {
          options: (value, { req }) => {
            ...
            // trong doc dòng dưới là [TweetType.Retweet, TweetType.Comment, TweetType.QuoteTweet].includes(type)
      ...
      content: {
        ...
        custom: {
          options: (value, { req }) => {
            ...
            // dòng if trong doc là [TweetType.Tweet, TweetType.Comment, TweetType.QuoteTweet].includes(type)
            if (
            ...
            //nếu type là retweet thì content ='', mention=[],  hashtag = []
